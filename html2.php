...
.w3-bar .w3-button {
  ...
  margin: auto;
    ...
    /* .backgroundStyle{
        background-image: url(menuImages/productPart.gif);
    ...
    <div class="w3-top">
        ...
        <div class="w3-bar w3-white w3-card" id="myNavbar">
            <!---<a href="#home" class="w3-bar-item w3-button w3-wide"><<b>FOODCOAST INTERNATIONAL</b></a>--->
               <a href="#home"> <img src="Images/FCI%20Logo%2080x140.jpg" class=""w3-bar-item w3-button w3-wide alt="LOGO" style="width: auto"></a>
            <!-- Right-sided navbar links -->

            <div class="w3-right w3-hide-small">
                <div class=" w3-left w3-dropdown-hover">

                    <a href="#about"><button class="w3-button w3-white">ABOUT US <!--<i class="fa fa-angle-double-down" style="font-size:18px;color:red"></i>---></button></a>
                    <div class="w3-dropdown-content w3-bar-block w3-card-4">
                        <a href="#coprateJourney" class="w3-bar-item w3-button">Our Coporate Journey</a>
                        <a href="#vison" class="w3-bar-item w3-button">Mission & Vision</a>
                        <a href="#ethics" class="w3-bar-item w3-button">Work Ethics </a>
                        <a href="certificate.php" class="w3-bar-item w3-button">Certificate</a>
                ...
                <div class="w3-dropdown-hover">
                    <button class="w3-button">FOOD SERVICE <!---<i class="fa fa-angle-double-down" style="font-size:18px;color:red"></i>---></button>
                    <div class="w3-dropdown-content w3-bar-block w3-card-4">
                        <!--        <a href="#work" class="w3-bar-item w3-button">Our Products</a>-->
                        <a href="Iamges.php" class="w3-bar-item w3-button">Institutional Product Range </a>
                        <a href="mapsPic.php" class="w3-bar-item w3-button">	Nationwide/ Our Presence</a>
                ...
                <div class="w3-dropdown-hover">
                    <button class="w3-button">RECIPE <!---<i class="fa fa-angle-double-down" style="font-size:18px;color:red"></i>---></button>
                    <div class="w3-dropdown-content w3-bar-block w3-card-4">
                        <a href="MainSalads.php" class="w3-bar-item w3-button">Salads</a>
                        <a href="deserts.php" class="w3-bar-item w3-button">Desert's</a>
                        <a href="drinkCoofiee.php" class="w3-bar-item w3-button">Drink</a>
                        <a href="party.php" class="w3-bar-item w3-button">Party</a>

                    </div>
                </div>

                <div class="w3-dropdown-hover">
                    <button class="w3-button">MEDIA <!---<i class="fa fa-angle-double-down" style="font-size:18px;color:red"></i>--></button>
                    <div class="w3-dropdown-content w3-bar-block w3-card-4">
                        <a href="pressRoom.php" class="w3-bar-item w3-button">Press Room </a>
                        <a href="Glimps2.php" class="w3-bar-item w3-button">Glimpse 2017-18</a>
...
<button class="w3-button w3-black w3-display-left" onclick="plusDivs(-1)">&#10094;</button>
  <button class="w3-button w3-black w3-display-right" onclick="plusDivs(1)">&#10095;</button>
    ...
    <div class="w3-container" style="padding:38px 16px" id="about">
    ...
    <div class="w3-container w3-light-white" style="padding:30px 10px" id="coprateJourney">
        ...
        <p class="w3-lobster w3-serif w3-large">
    ...
    <div class="w3-container w3-white" style="padding:30px 16px" id="vison">
        <p class="w3-center w3-xlarge w3-text-dark-black"><span class="w3-text-red"style="font-family:sans-serif;color:  #ff0000">Our Vison And Mission</span></p>
            ...
            <h2 class="w3-xlarge w3-text-red">Vision</h2>

        <p class=" w3-lobster w3-serif w3-large" >To transform Indian food processing industry by catering real Indian flavors across the globe. Delivering committed, customized and consistent service, thus, making FOODCOAST, a force to reckon with.</p>

        <h2>
        <p class="w3-xlarge w3-text-red" style="margin-left:0px">Mission</p>
        </h2>
        <p class=" w3-lobster w3-serif w3-large">We create the most authentic and finest flavors for Indian palates for catering organic Indian tastes worldwide, thereby taking “ Foodcoast to every coast” at affordable prices. </p>
    </div>
        <hr>
    ...
    <div class="w3-container w3-light-white" style="padding:50px 10px" id="ethics">
        ...
        <ul>
            <h3 class="w3-xlarge w3-text-red">Commitment to Serve</h3>
        </ul>

        <p class="w3-lobster w3-serif w3-large">We see our business associates and customers as our core strength. We connect with the customers to deliver extraordinary services anywhere and everywhere. We envisage the company to become an outstanding partner to our customers by ensuring commitment of delivering the best quality of products and contemporary flavours to relish.</p>

        <ul>
            <h3 class="w3-xlarge w3-text-red">RIGHT IN FIRST TIME</h3>
        </ul>
        <p class="w3-lobster w3-serif w3-large">Foodcoast believes in - RIGHT IN FIRST TIME. To achieve this Foodcoast has engaged a team for quality assurance to review all the factors related to production - from raw material to finished goods. We are equipped with both chemical and microbiological labs integrated with the latest testing equipment. A team for R&D has also been engaged to create new products so as to offer great choices to the consumers, reduce costs, improve nutritional value of food "Keeping Indian palates in Mind"

        <ul>
            <h3 class="w3-xlarge w3-text-red">Total Quality Management</h3>
        </ul>
        <p class="w3-lobster w3-serif w3-large">We endeavor to manufacture and develop products of finest quality and the taste by means of
        ...
        <ul>
            <h3 class="w3-xlarge w3-text-red">Quality Check</h3>
        </ul>
        <p class="w3-lobster w3-serif w3-large">FCI endeavors to keep up its commitment to customer service by relying upon time tested principals of “Just in Time” (JIT) and “Total Quality Management” (TQM). Quality assurance department conducts a standard quality check procedure to ensure premium quality of products. Top- notch chemical & microbiological labs are equipped with the latest testing equipment to deliver the best quality
        <blockquote><p class="w3-wide w3-large"><strong>"FCI quality assurance team ensures optimal nutritional value infused with great flavor packaged in a
    ...
    <div class="stback">
        <div class="w3-container" style="padding: 20px 10px"id="team">
            <h3 class="w3-center"><span class="w3-text-red"style="font-family:sans-serif;color:  #ff0000">THE TEAM</span></h3>
             ...
             <div class="w3-row-padding" style="margin-top:0px">
                 <h3 class="w3-center">Our Inspiration</h3>
                     ...
                     <div class="w3-container w3-center" style="width: 40%;margin-left: 400px">
                         <img src="Catalogue/2.jpg" style="width: 50%">
                         <h5>Late Pandit Harbans Lal Sharma</h5>
...
-->
    ...
    <div class="w3-container w3-light-grey w3-padding-64">
        ...
        <div class="w3-row-padding">
            ...
            <div class="w3-col m6">
                ...
                <p class="w3-wide"><i class="fa fa-photo w3-margin-right"></i>Mayonises</p>
                <div class="w3-grey">
    ...
    <div class="w3-container w3-light-grey" style="padding:128px 16px" id="contact">
        ...
        <div class="w3-row-padding" style="margin-top:64px">
            <div class="w3-half">
                <p class="w3-large"><i class="fa fa-map-marker fa-fw w3-xlarge w3-margin-right"></i>Foodcoast International A-23A Focal Point Extension,Jalandhar-144004</p>

                <p class="w3-large"><i class="fa fa-phone fa-fw w3-xlarge w3-margin-right"></i><b> Phone: 1800 274 274 0 ,  91 181 5077771/72</b></p>
                <p class="w3-large"><i class="fa fa-envelope fa-fw w3-xlarge w3-margin-right"> </i> Email:     info@foodcoast.com</p>
                <br>
                <form action="" target="_blank">
                    <p><input class="w3-input w3-border" type="text" placeholder="Name" required name="Name"></p>
                    <p><input class="w3-input w3-border" type="text" placeholder="Email" required name="Email"></p>
                    <p><input class="w3-input w3-border" type="text" placeholder="Subject" required name="Subject"></p>
                    <p><input class="w3-input w3-border" type="text" placeholder="Query" required name="Message"></p>
                    <p>
